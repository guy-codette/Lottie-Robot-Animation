...
export default function Animation404() {
    ...
    return (
        <div style={{width: '300px', height: '300px'}}>
            ...
            />
            {dotLottie ? (
                <div className="flex items-center text-xs text-zinc-700 gap-4">
                    ...
                    <span>{dotLottie.totalFrames}</span>
                </div>
            ) : (
            ...
            <div className="flex items-center justify-center gap-1 mt-4">
                <button onClick={handleFirstPart}
                        className={clsx(
                            "block py-1 px-2 text-xs font-mono uppercase rounded-sm bg-zinc-700",
